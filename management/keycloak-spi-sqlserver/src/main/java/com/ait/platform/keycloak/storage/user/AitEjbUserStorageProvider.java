 ...
 */
@Stateful
@Local(AitEjbUserStorageProvider.class)
public class AitEjbUserStorageProvider implements UserStorageProvider, //
		UserLookupProvider, //
		...
		OnUserCache //
{
	private static final Logger logger = Logger.getLogger(AitEjbUserStorageProvider.class);
	...
	public UserModel getUserByUsername(String username, RealmModel realm) {
		...
		if (result.isEmpty()) {
			logger.info("No fue posible encontrar el usuario por username: " + username);
			return null;
		}
	...
	public UserModel getUserByEmail(String email, RealmModel realm) {
		...
		List<UserEntity> result = query.getResultList();
		if (result.isEmpty()) {
			logger.info("No fue posible encontrar el usuario por email: " + email);
			return null;
		}
		return new UserAdapter(session, realm, model, result.get(0));
	}
	...
	public boolean isValid(RealmModel realm, UserModel user, CredentialInput input) {
		...
		logger.info("user pwd: " + password);
		logger.info("input pwd: " + cred.getValue());
