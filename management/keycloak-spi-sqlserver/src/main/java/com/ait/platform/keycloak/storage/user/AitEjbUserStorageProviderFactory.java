 ...
 * @version $Revision: 1 $
 */
public class AitEjbUserStorageProviderFactory implements UserStorageProviderFactory<AitEjbUserStorageProvider> {
    
	private static final Logger logger = Logger.getLogger(AitEjbUserStorageProviderFactory.class);
    ...
    @Override
    public String getId() {
        return "ait-user-storage-jpa";
    }

    @Override
    public String getHelpText() {
        return "AIT-JPA User Storage Provider";
    }
